...
bool motherboard::operator==(motherboard mb)
{
    if(this->CPU_chipset == mb.CPU_chipset)
    {
        ...
        {
            if(this->GPU_PCIE20_16x_number == mb.GPU_PCIE20_16x_number)
            {
                if(this->GPU_PCIE20_1x_number == mb.GPU_PCIE20_1x_number)
                {
                    if(this->GPU_PCIE20_4x_number == mb.GPU_PCIE20_4x_number)
                    {
                        if(this->GPU_PCIE20_8x_number == mb.GPU_PCIE20_8x_number)
                        {
                            if(this->GPU_PCIE30_16x_number == mb.GPU_PCIE30_16x_number)
                            {
                                if(this->GPU_PCIE30_1x_number == mb.GPU_PCIE30_1x_number)
                                {
                                    if(this->GPU_PCIE30_4x_number == mb.GPU_PCIE30_4x_number)
                                    {
                                        if(this->GPU_PCIE30_8x_number == mb.GPU_PCIE30_8x_number)
                                        {
