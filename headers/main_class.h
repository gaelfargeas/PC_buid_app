...
public:
    ...
    QList<GPU> apply_gpu_list_filters(QList<GPU> list, int no_motherboard, QString name_filter, int pcie_16x_slot, int pcie_8x_slot,
    ...
    QList<GPU> gpu_list_bus_filter(QList<GPU> list, int pcie_16x_slot, int pcie_8x_slot,
                                   int pcie_4x_slot, int pcie_1x_slot,
                                   int used_pcie_16x, int used_pcie_8x, int used_pcie_4x, int used_pcie_1x);
